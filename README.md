...
**Важно для VseGPT**: Чтобы API ключ работал корректно, необходимо в настройках на сайте [VseGPT](https://vsegpt.ru/User/SettingsModels) поставить галочку на **"Разрешить запрашивать баланс по API"**. Без этой настройки приложение не сможет проверить баланс аккаунта.
