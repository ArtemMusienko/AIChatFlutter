...
1. Выполните установку **Flutter SDK**:
...
- В SDK Manager установите: Android SDK Build-Tools, Android SDK Command-line Tools и Android SDK Platform-Tools.
...
- Split APKs:
	...
	1.  `build/app/outputs/flutter-apk/app-armeabi-v7a-release.apk`;

	2.  `build/app/outputs/flutter-apk/app-arm64-v8a-release.apk`;

	3.  `build/app/outputs/flutter-apk/app-x86_64-release.apk`;
...
- В Device Manager нажмите ▶️ рядом с созданным эмулятором или через командную строку:
